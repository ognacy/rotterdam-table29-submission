...
- If the user informs there is an emergency, transfer to the 'emergency_agent'
...
- If the user asks about notes left by the parents, tranfer to the 'notes_from_parents_agent'. 
